"""
Django settings for fileload project.
...
SECRET_KEY = "django-insecure-ya*q#ls+rt*dk79e8w1t5s*()0)6+^2s^lej%qof%93r&f0slw"
...
WSGI_APPLICATION = "fileload.wsgi.application"
